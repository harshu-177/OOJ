...
ax<sup>2</sup> +bx+c = 0. Read in a, b, c and use the quadratic formula. If the discriminate b 2 -4ac
is negative, display a message stating that there are no real solutions.

    File Name : [Quadratic Equation](https://github.com/harshu-177/OOJ/blob/main/Code/Quadratic.java)
...
method to calculate SGPA of a student.
    ...
    File Name : [Student Class](https://github.com/harshu-177/OOJ/blob/main/Code/Student.java)
...
complete details of the book. Develop a Java program to create n book objects.
    ...
    File Name : [Book Class](https://github.com/harshu-177/OOJ/blob/main/Code/Book.java)
...
area of the given shape.
    ...
    File Name : [Abstract Shape Class](https://github.com/harshu-177/OOJ/blob/main/Code/Shape.java)
...
Check for the minimum balance, impose penalty if necessary and update the balance.
    ...
    File Name : [Bank Class](https://github.com/harshu-177/OOJ/blob/main/Code/Bank.java)
